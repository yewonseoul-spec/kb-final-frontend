...
// addSheetDate: 어떤 날짜에 추가할지 (ExpectedCreate에 props로 넘겨준다)
...
// 그 날 예상 소비 중에 "정기 지출로 자동 등록된 것"이 하나라도 있는지 확인한다.
// 있으면 칸 위쪽에 작은 "자동" 배지를 띄워준다.
// function hasAutoGenerated(day) {
//   return day.expectedSpendings.some(s => s.autoGenerated);
// }
